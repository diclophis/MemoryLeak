...
//#ifndef __I_STREAM_XML_READER_IMPL_H_INCLUDED__
//#define __I_STREAM_XML_READER_IMPL_H_INCLUDED__
...
class StreamXMLReader : public IIrrXMLReader<char_type, superclass>
{
public:

	//! Constructor
	StreamXMLReader(IFileReadCallBack* callback, bool deleteCallBack = true)
...
private:
	...
	public: bool readFile(int size, char *buf)  //(IFileReadCallBack* callback)
	{
